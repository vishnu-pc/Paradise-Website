  ...
  return (
    <>
      ...
      <div className="about-slide1">
        <h1 style={{ fontSize: "200px", padding: "20px", textAlign: "center" }}>
          Process
        </h1>
        <Row className="gx-0">
          <Col xs={12} md={6}>
          ...
          <Col xs={12} md={6}>
            <div className="about-slide-text-section">
              <p>
                ...
                Paradise Stile studio is one of the main voices in the floor and
                wall tiles distribution market. Situated in Indiranagar,
                Bangalore, we are a sanctuary for designer tiles and bring a new
                and more nuanced voice to the sector.
                <br></br>
                <br></br>
                Our vision is to be an all inclusive hub for aesthetic building
                materials, providing lavish items that are customized to the
                aesthetic of your architectural wonder. Our mission is to be the
                go-to brand when one considers luxurious interiors and
                exteriors.
                <br></br>
                <br></br>
                <br></br>
