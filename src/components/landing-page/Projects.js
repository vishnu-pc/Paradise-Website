                ...
                <div className='recent-project-grid'>
                    <Container>
                        <Row className='recent-project-row'>
                            <Col xs={12} md={4} className='recent-project-col'>
                                <div className='recent-project-image-container'>
                                    <img src= '/assets/images/px-recent-projects-1-1_750.webp' alt="Category 1"/>
                                </div>
                            ...
                            <Col xs={12} md={4} className='recent-project-col'>
                                <div className='recent-project-image-container'>
                                    <img src= '/assets/images/px-recent-projects-2-1_600.webp' alt="Category 2"/>
                                </div>
                                <div className='recent-project-text'>
                                    <div className='project-name'>
                                        Oriental Mindset
                            ...
                            <Col xs={12} md={4} className='recent-project-col'>
                                <div className='recent-project-image-container'>
                                    <img src= '/assets/images/px-recent-projects-3-1_600.webp' alt="Category 3"/>
                                </div>
                                <div className='recent-project-text'>
                                    <div className='project-name'>
                                        Coastal Rendezvous
                        ...
                        <Row className='recent-project-row'>
                            <Col xs={12} md={4} className='recent-project-col'>
                                <div className='recent-project-image-container'>
                                    <img src= '/assets/images/px-recent-projects-4-1_600.webp' alt="Category 4"/>
                                </div>
                                <div className='recent-project-text'>
                                    <div className='project-name'>
                                        Traditional Condo
                            ...
                            <Col xs={12} md={4} className='recent-project-col'>
                                <div className='recent-project-image-container'>
                                    <img src= '/assets/images/px-recent-projects-5-1_1250.webp' alt="Category 5"/>
                                </div>
                                <div className='recent-project-text'>
                                    <div className='project-name'>
                                        Artistic Vigor
                            ...
                            <Col xs={12} md={4} className='recent-project-col'>
                                <div className='recent-project-image-container'>
                                    <img src= '/assets/images/px-recent-projects-6-1_600.webp' alt="Category 6"/>
                                </div>
                                <div className='recent-project-text'>
                                    <div className='project-name'>
                                        Bohemian Escape
