...
export default class DevTeamV2 extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <>
        <TransitionMotion willLeave={this.willLeave} styles={styles}>
          {circles =>
            <div
              ...
              className="dev-ripple-effect">
              {circles.map(({key, style: {opacity, scale, x, y}}) =>
                <div
                  key={key}
                  className="dev-ripple-ball"
                  style={{
                    opacity: opacity,
                    scale: scale,
        ...
        {/* <div className="yolo">Welcome to my Website</div> */}
      </>
    );
  };
}